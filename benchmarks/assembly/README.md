...
| sdf_resolution.py | STL SDF 分辨率、计时、可选 profile / HTML 对照 |
...
`sdf_resolution.py` 默认 `EXPORT_HTML = False`；需要分辨率对照页时设为 `True`。这是保留的独立网页报告，原来的多个 contact 网页演示已经合并到 [WRS 例子](../../examples/assembly/README.md)。
