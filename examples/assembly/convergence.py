...
def main():
    ...
    parser.add_argument('--out',type=Path,default=ROOT/'examples'/'assembly'/'output'/'convergence.json')
    ...
    save_report({'mesh_refinement':distance_rows,'band_refinement':band_rows,
                 'note':'Near-band boundary uncertainty remains explicit; area estimates are not physical contact area.'},args.out)
