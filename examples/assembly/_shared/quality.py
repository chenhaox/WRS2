"""S/G/A quality search, its small scenes and the WRS replay panel."""
import numpy as np
from wrs.assembly import (Assembly, AuxiliarySupport, SupportCandidate, GraspabilityAnalyzer,
    ...
    analyze_contacts, score_assemblability, solve_directions)
from .stability_cases import block
...
def show(assembly,analyzer,hand,result,port):
    ...
    from .contact_display import draw_contacts,contact_layers
